...
void DirectXCommon::DeptBufferInitialize()
{
    HRESULT result{};
...
ID3D12DescriptorHeap* DirectXCommon::CreateDescriptorHeap(D3D12_DESCRIPTOR_HEAP_TYPE heepType, UINT numDescripots, bool shaderVisible)
{
